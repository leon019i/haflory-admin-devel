                  ...
                  >
                    <label for="fileInput" slot="upload-label">
                      <v-col align="start" class="pa-0 ma-0">
                        ...
                        <img v-if="item.image != null" class="image-custom-preview" :src="item.url" />
                        ...
                        >
                          {{
                          item.image != null ? $t('product.product.clicktochange') : $t('product.product.clicktoupload')
                          }}
                        </p>
                      </v-col>
                    </label>
...
export default {
  data() {
    return {
      categoryInput: {
        ...
        subCategory: this.currentCategory.subCategories,
      },
      nameEnError: "",
      nameArError: "",
      images: [],
  ...
  methods: {
    ...
    setImage(output) {
      ...
      this.categoryInput.subCategory[this.selectedIndex].image = output;
    },
    setLogo(output) {
      this.hasLogo = true;
