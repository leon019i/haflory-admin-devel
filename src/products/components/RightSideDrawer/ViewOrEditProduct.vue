                  ...
                  <v-row align="center">
                    <v-col cols="8" align="center">
                      <avatar
                        ...
                        :username="!$store.getters.rtl ? 'Image M G' : 'صورة المنتج' "
                      />
...
export default {
  data() {
    return {
      productInput: {
        ...
        nameEn: this.currentProduct.nameEn,
        nameAr: this.currentProduct.nameAr,
        active: this.currentProduct.active,
        descriptionEn: this.currentProduct.descriptionEn,
        descriptionAr: this.currentProduct.descriptionAr,
        createdBy: this.currentProduct.createdBy._id,
        subCategory: this.currentProduct.subCategory._id,
        avatar: this.currentProduct.avatar != null ? this.productImages() : [],
        order: this.currentProduct.order,
      ...
      images: this.currentProduct.avatar,
      errorFromApi: "",
      hasImage: false,
      variables: {
        limit: 0,
  ...
  methods: {
    productImages() {
      let arr = [];
      this.currentProduct.avatar.forEach((element) => {
        arr.push({
          avatar: element,
          url: null,
        });
    ...
    editThisProduct() {
      ...
      updateProduct(this.productInput, this.sellersVariables).then((data) => {
        if (!!data.data) {
