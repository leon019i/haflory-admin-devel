...
<script>
import { createAreaTransferPrice } from "@/pricing/methods/create_area_to_area.js";
...
export default {
  ...
  methods: {
    ...
    addThisProduct() {
      ...
      createAreaTransferPrice(this.areaInput).then((data) => {
        if (!!data.data) {
